...
//   return (
//     <div className="w-110 bg-[#1e293b] text-white p-6 shadow-lg border-r border-slate-700 space-y-6">
//       <h2 className="text-xl font-semibold text-slate-200 mb-3">Input Method</h2>

//       {/* Tabs */}
//       <div className="flex border-b border-slate-600 mb-4">
//         {["JSON Editor", "File Upload"].map((tab) => (
//           <button
//             key={tab}
//             onClick={() => setActiveTab(tab)}
//             className={`flex-1 text-sm font-medium px-3 py-2 rounded-t-md transition-all ${
//               activeTab === tab
//                 ? "bg-black text-white border border-blue-900 border-b-0 shadow-inner cursor-pointer hover:bg-slate-700"
//                 : "bg-slate-900 text-white cursor-pointer hover:bg-slate-700"
//             }`}
//           >
//             {tab}
//           </button>
...
//                 className="w-full h-64 px-4 py-2 text-gray-200 bg-gray-900 border border-gray-700 rounded-md focus:outline-none focus:ring-2 focus:ring-orange-500"
//             />
//             <button
//               onClick={handleTextSubmit}
//               className="flex items-center justify-center gap-2 text-white rounded w-full"
//             >
//               <Zap size={16} />
//               Apply JSON
//             </button>
...
//             <button
//                 onClick={clearInput}
//                 className="w-full py-2 bg-slate-600 hover:bg-slate-700 text-white rounded font-medium flex items-center justify-center gap-2"
//             >
//                 <Trash2 size={16} />
//                 Clear
//             </button>
...
//         <div className="h-64 border-2 border-dashed border-slate-500 rounded-lg p-6 text-center space-y-3 flex flex-col items-center justify-center">
...
//           {/* Action Buttons */}
//           <div className="flex flex-col flex-1 align-center justify-center gap-2">
//             <button
//               onClick={() => rawText && handleTextSubmit()}
//               className="flex items-center justify-center gap-2 text-white rounde"
//             >
//               <Zap size={16} />
//               Apply JSON
//             </button>
